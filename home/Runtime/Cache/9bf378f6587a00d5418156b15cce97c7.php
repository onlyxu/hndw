 ...
 <!-- sidebar end -->
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>新闻列表</small></div>
    </div>
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <button type="button" onclick="window.location.href='__ROOT__/index.php/pre_news_add/news'" class="am-btn am-btn-default"><span class="am-icon-plus"></span>新增</button>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
         ...
         <?php if(is_array($items)): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><a href="__ROOT__/index.php/pre_news_add/news/id/<?php echo ($vo["id"]); ?>"><?php echo (msubstr($vo["title"],0,25,'utf-8',true)); ?></a></td>
...
<script type="text/javascript" src="__PUBLIC__/js/news/newsList.js"></script>
</body>
</html>