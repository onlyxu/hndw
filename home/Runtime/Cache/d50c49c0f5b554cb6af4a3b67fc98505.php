 ...
 <!-- sidebar end -->
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>产品分类</small></div>
    </div>
...
<script type="text/javascript" src="__PUBLIC__/js/product/productTypeList.js"></script>
</body>
</html>