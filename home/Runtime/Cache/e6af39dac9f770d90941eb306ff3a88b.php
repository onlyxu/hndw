      ...
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
        <div class="am-g am-margin-top">
          ...
          <div class="am-u-sm-10">
            <select name="typeid">
            <?php if(is_array($cateList)): $i = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i; if($content['typeid'] == $cate['id']): ?><option selected="selected" value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["title"]); ?></option>
            	<?php else: ?>
        ...
        <div class="am-g am-margin-top">
          ...
          <div class="am-u-sm-10">
            ...
            <?php if($content["showing"] == 1): ?><label class="am-btn am-btn-default am-btn-xs" for="option1">
	...
	<!-- 中文详细信息TAB -->
      <div class="am-tab-panel am-fade" id="tab2">
         ...
         <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8">
              <input type="text" class="am-input-sm" name="keyword" value="<?php echo ($content["keyword"]); ?>"  />
            </div>
         ...
         <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-10">
              <textarea rows="10" name="content" id="content"><?php echo ($content["content"]); ?></textarea>
            </div>
          </div>
      </div>
	<!-- 英文详细信息TAB -->
      <div class="am-tab-panel am-fade" id="tab3">
         <div class="am-g am-margin-top">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8">
              <input type="text" class="am-input-sm" id="title_en" name="title_en" value="<?php echo ($content["title_en"]); ?>" />
            </div>
             <div class="am-u-sm-2">*必填，</div>
          </div>
         <div class="am-g am-margin-top">
            <div class="am-u-sm-2 am-text-right">关键字</div>
            <div class="am-u-sm-8">
              <input type="text" class="am-input-sm" name="keyword_en" id="keyword_en" value="<?php echo ($content["keyword_en"]); ?>" />
            </div>
             <div class="am-u-sm-2">*必填，不可重复</div>
         </div>
          ...
          <div class="am-g am-margin-top-sm">
            <div class="am-u-sm-2 am-text-right">内容描述</div>
            <div class="am-u-sm-10">
              <textarea rows="10" name="content_en" id="content_en"><?php echo ($content["content_en"]); ?></textarea>
            </div>
          </div>
      </div>
